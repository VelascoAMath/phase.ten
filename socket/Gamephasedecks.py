...
class Gamephasedecks(BaseModel):
    ...
    def __eq__(self, other):
        if isinstance(other, Gamephasedecks):
            ...
            return self.id == other.id and self.game == other.game and self.phase == other.phase and self.deck == other.deck and self.created_at == other.created_at and self.updated_at == other.created_at
        else:
            return False
